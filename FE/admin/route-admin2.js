var myApp = angular.module("testCuaHang2", ["ngRoute"]);
myApp.config(function ($routeProvider, $locationProvider) {
  $locationProvider.hashPrefix("");
  $routeProvider
    .when("/view-admin-login", {
      templateUrl: "./pages/form-login-admin.html",
    ...
    .when("/acc-admin", {
      templateUrl: "./pages/acc-admin.html",
      // controller: loginAdminController,
    })
    .when("/admin/home2", {
      templateUrl: "./pages/dashboard.html",
    })
    .when("/view-quan-ly-hoa-don", {
      templateUrl: "./pages/view-quan-ly-hoa-don.html",
      controller: getHD,
    })
    ...
    .otherwise({ redirectTo: "/view-admin-login" });
});
